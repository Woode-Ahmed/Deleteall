...
'
echo " " 
echo -e "$red                       ▶Coded by$grn WOODE$red◀$rset"
echo -e "$red                      ⫸$ylo  Woode cam back$red ⫷$rset"
echo 
# Functions
...
then
am start -a android.intent.action.VIEW -d https://www.facebook.com/a.woode.249 > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
am start -a android.intent.action.VIEW -d https://t.me/NO_BRAK > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m                  CALL ME \e[92mWOODE" | pv -qL 10
echo -e "\e[93m             IAM FROM \e[92mSOME HACKERS" | pv -qL 10
...
echo -e "\e[93m        MY WEBSITE:\e[92m www.woode-hackers.com\e[0m" | pv -qL 10
